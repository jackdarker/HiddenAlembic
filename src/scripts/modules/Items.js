...
class Ingredient extends Item {
    ...
    //Molchaugen, Krötenbein, Dachshaar, Hirschhorn
    //Pottasche, Quarz, Schlamm,
    //Melisse, Eisenhut, Fingerhut, Sellerie, Pfefferminze, Schafgarbe, Echte Engelwurz, Ringelblume, Johanniskraut, Echter Lavendel, Echte Kamille, Zitronenmelisse, Echter Salbei, Beinwell, Quendel, Baldrian, Königskerze
    get style() {return this._style;}
    get desc() { 
        let msg ='';
        switch(this._style) {
...
class Pills extends Item {
    ...
    set style(style) {
        ...
        else if(style===60) this.id=this.name='WhitePill';
        else throw new Error(this.id +' doesnt know '+style); 
    }
    get style() {return this._style;}
    get desc() { 
